...
Now that we have explored the input files, we are ready to open Marxan Connect and load our project. Please load the `tutorial.MarCon` file in the **CF_demographic** folder into Marxan Connect. 
File-> Load Project_> "tutorial.MarCon"
