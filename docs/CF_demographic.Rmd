...
groups <- names(select(output,-best_solution,-select_freq, -google_demo_pu))[c(-1,-2)]
...
Once the desired options have been chosen, press **Export Files** in the bottom right corner of the screen. This will create two new files (or update the files, as they have already been created) called **puvspr_connect.dat** and **spec_connect.dat** in the **input** folder of the **CF_demographic** folder.
