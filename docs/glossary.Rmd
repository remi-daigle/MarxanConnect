...
It should be noted that both of approaches of incorporating connectivity into Marxan (as conservation features or as an [spatial dependency](glossary.html#connectivity-as-spatial-dependency)) can be used alone or in combination. In all cases, an appropriate level of sensitivity testing should be completed to help with interpretation and communication of outcomes. 
