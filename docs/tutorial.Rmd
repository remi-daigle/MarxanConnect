...
<!-- ```{r} -->
<!-- conmat <- read.csv("tutorial/CSM_demographic/reefFlow.csv")[1:7,1:7] -->
<!-- datatable(conmat,rownames = FALSE, options = list(searching = FALSE)) -->
<!-- ``` -->
...
<!-- Download the example [project folder](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/remi-daigle/MarxanConnect/tree/master/../docs/tutorial/CSM_landscape). This folder contains the Marxan Connect Project file, the input data, and the output data from this example. Feel free to follow along using Marxan Connect by loading `tutorial.MarCon`. -->
