...
groups <- names(select(output,-id, -pu_id, -Y_COORD, -X_COORD, -TARGET_FID, -GAZ_LOC_CO, -GBR_NAME, -Join_Count, -PERIMETER, -QLD_NAME, -REEFS_, -REEFS_ID, -REEF_ID, -SUB_ID, -status, -google_land_pu_R))[c(-1,-2)]
groups <- groups[groups!="geometry"]
