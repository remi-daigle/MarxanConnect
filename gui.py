...
class MarxanConnectGUI ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		startMainSizer = wx.FlexGridSizer( 0, 1, 0, 0 )
		...
		connMainSizer.AddGrowableRow( 1 )
		connMainSizer.AddGrowableRow( 4 )
		connMainSizer.AddGrowableRow( 6 )
		connMainSizer.AddGrowableRow( 10 )
		...
		self.m_staticText38 = wx.StaticText( self.demographic, wx.ID_ANY, u"Output:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_auinotebook1.AddPage( self.connectivityInput, u"Connectivity Input", True, wx.NullBitmap )
