...
class MarxanConnectGUI ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.gettingStarted1 = wx.Panel( self.m_auinotebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.m_auinotebook1.AddPage( self.gettingStarted1, u"Getting Started", False, wx.NullBitmap )
		self.demographicInput1 = wx.Panel( self.m_auinotebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		...
		self.m_staticText12 = wx.StaticText( self.demographicInput1, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText12.Wrap( -1 )
		sizer10.Add( self.m_staticText12, 0, wx.ALL, 5 )
		
		self.rescale_button = wx.Button( self.demographicInput1, wx.ID_ANY, u"Rescale Connectivity Matrix", wx.DefaultPosition, wx.DefaultSize, 0 )
		sizer10.Add( self.rescale_button, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )
		...
		self.m_auinotebook1.AddPage( self.demographicInput1, u"Demographic Input", True, wx.NullBitmap )
		self.geneticInput1 = wx.Panel( self.m_auinotebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.geneticInput1.Hide()
		
		self.m_auinotebook1.AddPage( self.geneticInput1, u"Genetic Input", False, wx.NullBitmap )
		self.landscapeInput1 = wx.Panel( self.m_auinotebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.landscapeInput1.Hide()
		
		self.m_auinotebook1.AddPage( self.landscapeInput1, u"Landscape Input", False, wx.NullBitmap )
		self.connectivityMetrics1 = wx.Panel( self.m_auinotebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.m_auinotebook1.AddPage( self.connectivityMetrics1, u"Connectivity Metrics", False, wx.NullBitmap )
