...
class MarxanConnectGUI ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.PU_file = wx.FilePickerCtrl( self.spatialInput, wx.ID_ANY, u"~\\data\\shapefiles\\marxan_pu.shp", u"Select a file", u"ESRI Shapefile (*.shp)|*.shp|GeoPackage (*.gpkg)|*.gpkg", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.FA_file = wx.FilePickerCtrl( self.spatialInput, wx.ID_ANY, wx.EmptyString, u"Select a file", u"ESRI Shapefile (*.shp)|*.shp|GeoPackage (*.gpkg)|*.shp", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.AA_file = wx.FilePickerCtrl( self.spatialInput, wx.ID_ANY, wx.EmptyString, u"Select a file", u"ESRI Shapefile (*.shp)|*.shp|GeoPackage (*.gpkg)|*.shp", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.demo_CU_file = wx.FilePickerCtrl( self.demographic, wx.ID_ANY, u"~\\data\\shapefiles\\connectivity_grid.shp", u"Select a file", u"ESRI Shapefile (*.shp)|*.shp|GeoPackage (*.gpkg)|*.gpkg", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.land_HAB_file = wx.FilePickerCtrl( self.hab_res, wx.ID_ANY, wx.EmptyString, u"Select a file", u"ESRI Shapefile (*.shp)|*.shp|GeoPackage (*.gpkg)|*.gpkg", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.land_RES_file = wx.FilePickerCtrl( self.res_suf, wx.ID_ANY, wx.EmptyString, u"Select a file", u"ESRI Shapefile (*.shp)|*.shp|GeoPackage (*.gpkg)|*.gpkg", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.inputdat_template_file = wx.FilePickerCtrl( self.marxanAnalysis, wx.ID_ANY, u"C:\\Users\\daigl\\Documents\\GitHub\\MarxanConnect\\Marxan243\\input_template.dat", u"Select a file", u"Marxan Data Files (*.dat)|*.dat", wx.DefaultPosition, wx.DefaultSize, wx.FLP_OPEN|wx.FLP_USE_TEXTCTRL )
		...
		marxan_RadioChoices = [ u"Marxan 2.4.3", u"Marxan 4.0.6" ]
		...
		self.marxanBit_Radio.SetSelection( 0 )
		...
		self.inputdat_file = wx.FilePickerCtrl( self.marxanAnalysis, wx.ID_ANY, u"C:\\Users\\Remi-Work\\Desktop\\MarxanConnectGUI\\data\\GBR\\input.dat", u"Select a file", u"Marxan Data Files (*.dat)|*.dat", wx.DefaultPosition, wx.DefaultSize, wx.FLP_OPEN|wx.FLP_USE_TEXTCTRL )
		...
		self.postHoc_custom_file = wx.FilePickerCtrl( self.postHocEvaluation, wx.ID_ANY, wx.EmptyString, u"Select a file", u"Comma Separated Values (*.csv)|*.csv", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.postHoc_shp_file = wx.FilePickerCtrl( self.postHocEvaluation, wx.ID_ANY, u"~\\postHoc.shp", u"Select a file", u"Comma Separated Values (*.csv)|*.csv", wx.DefaultPosition, wx.DefaultSize, wx.FLP_OPEN|wx.FLP_USE_TEXTCTRL )
...
class GettingStarted ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText1002 = wx.StaticText( self.m_panel27, wx.ID_ANY, u"How to cite (will have DOI, etc later):\n\nDaigle, RM; Metaxas, A; Balbar, AC; McGowan, J; Treml, EA; Kuempel, CD; Possingham, HP; Beger, M. 2018. Marxan Connect v1.0.1-rc2021.12.01.23. https://github.com/remi-daigle/MarxanConnect", wx.DefaultPosition, wx.DefaultSize, 0 )
